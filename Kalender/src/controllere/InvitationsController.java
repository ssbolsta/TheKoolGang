...
public class InvitationsController {
	...
	private void initialize(){
		...
		invitationTableList.add(new Invitation(new Person("Boye","Data",1236),new Person("John","Smith",1237), new Event("Harem",LocalDate.of(2015, 3,25 ),LocalTime.of(12, 0),LocalTime.of(14, 0),"Vi skal holde et stort harem på jobben. Bar eå komme, blir masse kos!",new Room(1,"Knøllerommet",50,"Pisker(4),Dildoer(20),Sex-svinge(2)"))));
